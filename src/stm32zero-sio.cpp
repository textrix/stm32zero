...
#ifndef STM32ZERO_SIO_NUM
#error "STM32ZERO_SIO_NUM must be defined in stm32zero-conf.h (e.g., #define STM32ZERO_SIO_NUM 3 for huart3/USART3)"
#endif
...
extern UART_HandleTypeDef STM32ZERO_SIO_HANDLE;

//=============================================================================
// Uart instance
//=============================================================================

STM32ZERO_DEFINE_UART(sio_uart_, STM32ZERO_SIO_HANDLE, STM32ZERO_SIO_TX_SIZE, STM32ZERO_SIO_RX_SIZE, STM32ZERO_SIO_DMA_SIZE);
...
void init()
{
	...
	STM32ZERO_INIT_UART(sio_uart_, STM32ZERO_SIO_HANDLE);
}
